...
// ======================================================
// Replace these four values before uploading. For a phone hotspot,
// use the computer's LAN IP in API_URL, not 127.0.0.1.
const char* WIFI_SSID = "Foxx";
const char* WIFI_PASSWORD = "@jamie.?1F.048#";
const char* API_URL = "http://192.168.5.36:8000/api/sensor-data/";
const char* API_KEY =  "1xT98P_Wfrf4BgLnkXlR9Ln-71oat_bLDtYj-piieP4";
